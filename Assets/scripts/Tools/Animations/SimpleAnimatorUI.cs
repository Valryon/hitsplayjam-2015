...
public sealed class SimpleAnimatorUI : MonoBehaviour
{
  ...
  void ChangeSprite()
  {
    ...
    {
      var t = (Texture2D)currentAnimation.frames[currentFrame];
      render.sprite =  Sprite.Create(t, new Rect(0, 0, t.width, t.height),new Vector2(0, 0));;
    }
  }
